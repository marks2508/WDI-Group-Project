...
const Trip = require('../models/post');
...
User
  ...
  .then((users) => {
    ...
    return Trip.create([{
      ...
      startPointLat: '41.878245 N',
      startPointLng: '-87.624432 W',
      endPointLat: '34.010959 N',
      endPointLng: '-118.495381 W',
      ...
      startPointLat: '23.6980° S',
      startPointLng: '133.8807° E',
      endPointLat: '25.3507° S',
      endPointLng: '131.0674° E',
